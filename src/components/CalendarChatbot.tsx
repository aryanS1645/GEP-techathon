...
// import { sendCalendarChatMessage } from '../services/api';

// const CalendarChatbot: React.FC = () => {
...
//     try {
//           let botResponse = '';
//             botResponse = await sendCalendarChatMessage(inputMessage, messages)
...
const CalendarChatbot: React.FC = () => {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      const botResponse = await sendCalendarChatMessage(inputMessage, messages);
